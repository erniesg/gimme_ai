// Workflow template for test-project
...
const apiBaseUrl = 'https://example.com';  // This will be replaced during template rendering

// Get steps from config
const workflowSteps = {{ workflow.steps | tojson }};  // This will be replaced during template rendering

/**
 * TestProjectWorkflow - A workflow for test-project
 * Type: {{ workflow.type }}
 */
export class TestProjectWorkflow extends WorkflowEntrypoint {
  /**
   * Run the workflow
   */
